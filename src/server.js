...
module.exports = async (client) => {
  ...
  app.use(async (req, res, next) => {
    ...
    if (geo) {
      ...
      await sitedatas.updateOne(
        { id: config.website.clientID },
  ...
  console.log(
    "\x1b[36m%s\x1b[0m",
    "[vcodes.xyz]: Uptime system routers loading..."
  );
  sleep(500);
  ...
  console.log(
    "\x1b[36m%s\x1b[0m",
    "[vcodes.xyz]: Profile system routers loading..."
  );
  sleep(500);
  ...
  console.log(
    "\x1b[36m%s\x1b[0m",
    "[vcodes.xyz]: Code Share system routers loading..."
  );
  sleep(500);
  ...
  console.log(
    "\x1b[36m%s\x1b[0m",
    "[vcodes.xyz]: Botlist system routers loading..."
  );
  sleep(500);
  ...
  console.log(
    "\x1b[36m%s\x1b[0m",
    "[vcodes.xyz]: Serverlist system routers loading..."
  );
  sleep(500);
    ...
    if (req.path.includes("/admin")) {
      if (req.isAuthenticated()) {
        if (
          ...
          req.user.id === "714451348212678658"
        ) {
          next();
        } else {
          res.redirect(
  ...
  console.log(
    "\x1b[36m%s\x1b[0m",
    "[vcodes.xyz]: Admin Panel system routers loading..."
  );
  sleep(500);
